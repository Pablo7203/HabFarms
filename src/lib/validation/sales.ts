...
export const birdSaleSchema=z.object({customerId:z.uuid(),flockId:z.uuid(),saleDate:z.iso.date(),category:z.enum(["live_bird","spent_layer","cull_bird"]),quantity:n.int().positive(),pricePerBird:n.positive(),amountPaid:n.nonnegative(),paymentMethod:z.enum(["cash","momo","bank_transfer","other"]),creditDays,notes:t});
